...
contract Bounties {
    ...
    */
    ...
    returns (uint)
    {
        bounties.push(Bounty(payable(msg.sender), _deadline, _data, BountyStatus.CREATED, msg.value));
    ...
    */
    ...
    {
        fulfillments[_bountyId].push(Fulfillment(false, payable(msg.sender), _data));
